...
THREAT_IPS = [
    "185.220.101.47", "45.33.32.156",  "104.21.33.14",
    "77.88.8.8",      "198.51.100.23", "192.0.2.88",
    "203.0.113.5",    "91.108.4.1",   "185.159.82.45",
    "51.15.193.47",   "167.99.247.3", "64.225.32.100",
]
...
def get_stats():
    ...
    top_ips = sorted(
        [{"ip": ip, "count": ip_counts[ip], "score": int(ip_scores[ip])} for ip in ip_counts],
